...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ScanTicketPurchaseRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CandidateCreateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/request.CandidateUpdateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.PlayerCreateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.PlayerUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/superadmin/purchases": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search by invoice external id / email",
                        "name": "search",
                        "in": "query"
                    },
                    {
        ...
        "/superadmin/season-team-players/position-list": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/superadmin/season-team-players/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Season Team Player ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SeasonTeamCreateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SeriesCreateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SeriesUpdateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.TicketCreateOrUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/webhook/xendit/snap": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Xendit Snap Webhook Payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SnapWebhookRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "request.ScanTicketPurchaseRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "request.SeasonTeamCreateRequest": {
            "type": "object",
            "properties": {
                "teamIds": {
                    "type": "array",
        ...
        "request.SeriesUpdateRequest": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/mongo_model.SeriesStatus"
                },
                "venueId": {
                    "type": "string"
                }
        ...
        "request.TicketCreateOrUpdateRequest": {
            "type": "object",
            "properties": {
                "seriesId": {
                    "type": "string"
                ...
                "tickets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.TicketRequest"
                    }
                }
            }
        },
        ...
        "request.TicketRequest": {
            ...
            "properties": {
                ...
                "matchs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.TicketMatchRequest"
                    }
                },
                "name": {
                    "type": "string"
